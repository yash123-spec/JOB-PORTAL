...
const AddJobModal = ({ defaultCompany = "", onClose, onCreate }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 overflow-y-auto">
            <div className="my-8 w-full max-w-3xl rounded-2xl bg-white p-6 text-slate-900 shadow-2xl">
                <div className="mb-5 flex items-center justify-between border-b pb-4">
                    ...
                    <button onClick={onClose} className="rounded-full p-1.5 text-gray-400 transition-colors hover:bg-gray-100 hover:text-gray-700">
                        <X size={22} />
                    </button>
                </div>
                            ...
                            {form.responsibilities.map((resp, index) => (
                                <div key={index} className="flex gap-2">
                                    <input
                                        ...
                                        className="flex-1 p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand focus:border-transparent"
                                    />
                ...
                <div className="mt-6 flex justify-end gap-3 border-t pt-4">
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="inline-flex items-center gap-1.5 rounded-lg bg-brand px-6 py-2 font-medium text-white transition-colors hover:bg-brand-dark disabled:cursor-not-allowed disabled:opacity-60"
                    >
                        <Plus size={16} /> {loading ? "Creating..." : "Create Job"}
                    </button>
                </div>
            </div>
        </div>
