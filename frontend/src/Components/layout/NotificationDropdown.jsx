...
const NotificationDropdown = () => {
    ...
    return (
        <div className="relative" onMouseEnter={handleEnter} onMouseLeave={handleLeave}>
            ...
            {/* Dropdown */}
            {isOpen && (
                <div className="absolute right-0 mt-2 w-96 bg-white rounded-lg shadow-2xl border z-50 max-h-[600px] flex flex-col overflow-hidden">
                    {/* Header */}
                                    ...
                                    >
                                        <div className="flex items-start gap-3">
                                            {(() => {
                                                ...
                                                return (
                                                    <div className={`flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full ${classes}`}>
                                                        <Icon size={16} />
                                                    </div>
                                                );
                                            })()}
                    ...
                    {notifications.length > 0 && (
                        <div className="p-3 border-t bg-gray-50">
                            <button
                                ...
                                className="w-full text-center text-sm font-medium text-brand hover:text-brand-dark"
                            >
