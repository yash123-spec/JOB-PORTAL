...
import { MapPin, Calendar, Bookmark, BookmarkCheck, ArrowLeft, Briefcase, Clock, DollarSign, Users, Send, ExternalLink, Link as LinkIcon } from "lucide-react";
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-lg p-6 border border-gray-200 sticky top-4">
                            ...
                            <div className="mt-6 space-y-3">
                                ...
                                {/* Message Recruiter — candidates only (recruiters use the Applicants list) */}
