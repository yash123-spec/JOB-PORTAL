...
const Messages = () => {
    ...
    return (
        <div className="h-[calc(100vh-72px)] overflow-hidden bg-gradient-to-b from-[#071025] via-[#071b2b] to-[#05141b] text-white">
                                        ...
                                        <>
                                            ...
                                            <div>
                                                ...
                                                {typingFrom === otherUser?._id ? (
                                                    <p className="text-sm text-teal-400 italic">typing…</p>
                            ...
                            <form onSubmit={handleSendMessage} className="p-4 border-t border-white/10">
                                <div className="flex gap-2 items-end">
                                    <textarea
                                        ...
                                        rows={1}
                                        className="flex-1 px-4 py-3 rounded-lg bg-white/5 border border-white/10 outline-none focus:border-teal-500 transition resize-none max-h-[140px] overflow-y-auto no-scrollbar"
                                        disabled={sending}
                                    />
                                    <button
                                        type="submit"
