                ...
                <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <div className="flex-1">
                        ...
                        <div className="mt-6 flex flex-wrap gap-3 items-center">
                            <button onClick={handleCancel} className="px-4 py-2 rounded-md border hover:bg-gray-50" disabled={saving}>
                                Cancel
                            </button>
                            <button onClick={handleSave} className="px-4 py-2 rounded-md bg-teal-500 text-white hover:bg-teal-600 disabled:opacity-50 disabled:cursor-not-allowed" disabled={saving}>
